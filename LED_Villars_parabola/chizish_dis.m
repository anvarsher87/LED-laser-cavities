...
% load('modeldan_garaki_NdKGW.mat')
% load('modeldan_garaki_10_6_nd_yag.mat')
load('modeldan_garaki_10mln_single.mat')
% load('mode_u_tek_1.mat')
% load('mode_tek.mat')
% xdfgcbhj
% load('pump_norm_tek.mat')
...
z_grid_number  = 50;        z_grid_size = 2*r_muhit/z_grid_number;
y_grid_number  = 500;       y_grid_size = L/y_grid_number;
...
for ix=1:ss0(1)
    ...
    for iy=1:ss0(2)
        ...
        for iz=1:ss0(3)
                ...
                if (((ix-1)*x_grid_size-ram)^2+((iz-1)*z_grid_size-ram)^2 <= ram^2)
...
%                     else
                    ...
                    zc=(iz-1)*z_grid_size-ram;
                    yc=(iy-1)*y_grid_size-0.5*L;
                    %                 xc
