...
% surf(zp+2*l, 25+25*y,xp,'EdgeColor', 'None', 'FaceColor', 'k', 'FaceAlpha', '0.1')

% surf(zp+2*l,(D-6)*y+D+3,xp,'EdgeColor', 'None', 'FaceColor', 'b', 'FaceAlpha', '0.2', 'LineWidth',1.5)
% surf(zp+2*l,(3)*y+2*D-3,xp,'EdgeColor', 'None', 'FaceColor', 'k', 'FaceAlpha', '0.4', 'LineWidth',1.5)
% surf(zp+2*l,(3)*y+D,xp,'EdgeColor', 'None', 'FaceColor', 'k', 'FaceAlpha', '0.4', 'LineWidth',1.5)

surf(zp,(D-6)*y+D+3,xp,'EdgeColor', 'None', 'FaceColor', 'b', 'FaceAlpha', '0.2', 'LineWidth',1.5)
surf(zp,(3)*y+2*D-3,xp,'EdgeColor', 'None', 'FaceColor', 'k', 'FaceAlpha', '0.4', 'LineWidth',1.5)
surf(zp,(3)*y+D,xp,'EdgeColor', 'None', 'FaceColor', 'k', 'FaceAlpha', '0.4', 'LineWidth',1.5)
