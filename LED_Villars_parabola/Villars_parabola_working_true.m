...
chizish=0;
used_f1=0;
nuqta_fotonlar_soni_max=10000000;
axis equal
hold on
sp=zeros(1,2500);
...
y_grid_number  = 199;       y_grid_size = D/y_grid_number;
...
for f=1:nuqta_fotonlar_soni_max
    ...
    %         fi1=(-1 + (1+1)*rand(1,1))*sa; psi1=(-1 + (1+1)*rand(1,1))*sa;
    %         yonalish=[sin(fi1)*sin(psi1)  sin(fi1)*cos(psi1) cos(fi1)];
