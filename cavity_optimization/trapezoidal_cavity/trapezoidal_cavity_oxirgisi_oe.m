...
[y, z] = meshgrid(yy,zz); % Generate x and y data
x=(d-b*y-c*z)/a;
surf(z+D/2, x+0.1, y, 'EdgeColor', 'k', 'FaceColor', 'c', 'FaceAlpha', '0.1', 'LineWidth',1.5); % Plot the surface
surf(z+D/2, x+3, y, 'EdgeColor', 'k', 'FaceColor', 'c', 'FaceAlpha', '0.4', 'LineWidth',1.5); % Plot the surface
%------------------------------LED rasmi (yon devor)---------------------------------------------
...
%-----------------chizish uchun--------------------------------------------
xx=linspace(LED_1,LED_1+H,2); zz=linspace(dw,D/2-dw,2);
[x, z] = meshgrid(xx,zz); % Generate x and y data
y=(d-a*x-c*z)/b;
surf(z, x, y, 'EdgeColor', 'k', 'FaceColor', 'b', 'FaceAlpha', '0.2', 'LineWidth',1.5); % Plot the surface


xx=linspace(LED_1,LED_1+H,2); zz=linspace(0,dw,2);
[x, z] = meshgrid(xx,zz); % Generate x and y data
y=(d-a*x-c*z)/b;
surf(z, x, y, 'EdgeColor', 'k', 'FaceColor', 'k', 'FaceAlpha', '0.4', 'LineWidth',1.5); % Plot the surface


xx=linspace(LED_1,LED_1+H,2); zz=linspace(D/2-dw,  D/2, 2);
[x, z] = meshgrid(xx,zz); % Generate x and y data
y=(d-a*x-c*z)/b;
surf(z, x, y, 'EdgeColor', 'k', 'FaceColor', 'k', 'FaceAlpha', '0.4', 'LineWidth',1.5); % Plot the surface
...
tek_8=[a b c d];
%-----------------chizish uchun--------------------------------------------
yy=linspace(ly,ly+dd, 2); zz=linspace(D/2+dw,D-dw, 2);
[y, z] = meshgrid(yy,zz); % Generate x and y data
surf(z, x, y, 'EdgeColor', 'k', 'FaceColor', 'b', 'FaceAlpha', '0.2', 'LineWidth',1.5); % Plot the surface


yy=linspace(ly,ly+dd,2); zz=linspace(D/2,D/2+dw,2);
[y, z] = meshgrid(yy,zz); % Generate x and y data
x=(d-b*y-c*z)/a;
surf(z, x, y, 'EdgeColor', 'k', 'FaceColor', 'k', 'FaceAlpha', '0.4', 'LineWidth',1.5); % Plot the surface


yy=linspace(ly,ly+dd,2); zz=linspace(D-dw,  D, 2);
[y, z] = meshgrid(yy,zz); % Generate x and y data
x=(d-b*y-c*z)/a;
surf(z, x, y, 'EdgeColor', 'k', 'FaceColor', 'k', 'FaceAlpha', '0.4', 'LineWidth',1.5); % Plot the surface
...
tek_9=[a b c d];
%---------------chizish uchun ---------------------------------------------
xx=linspace(0,LED_2,2); zz=linspace(D/2+dw,D-dw,2);
[x, z] = meshgrid(xx,zz); % Generate x and y data
y=(d-a*x-c*z)/b;
surf(z,x, y,  'EdgeColor', 'k', 'FaceColor', 'b', 'FaceAlpha', '0.2',  'LineWidth',1.5); % Plot the surface


xx=linspace(0,LED_2,2); zz=linspace(D/2+dw,D/2+dw,2);
[x, z] = meshgrid(xx,zz); % Generate x and y data
y=(d-a*x-c*z)/b;
surf(z,x, y,  'EdgeColor', 'k', 'FaceColor', 'k', 'FaceAlpha', '0.4',  'LineWidth',1.5); % Plot the surface

xx=linspace(0,LED_2,2); zz=linspace(D-dw,D,2);
[x, z] = meshgrid(xx,zz); % Generate x and y data
y=(d-a*x-c*z)/b;
surf(z,x, y,  'EdgeColor', 'k', 'FaceColor', 'k', 'FaceAlpha', '0.4',  'LineWidth',1.5); % Plot the surface
...
tek_10=[a b c d];
%-------------------chizish uchun------------------------------------------
xx=linspace(LED_2,0,2); zz=linspace(D-dw,D/2+dw,2);
[x, z] = meshgrid(xx,zz); % Generate x and y data
y=(d-a*x-c*z)/b;
surf(z, x, y, 'EdgeColor', 'k', 'FaceColor', 'b', 'FaceAlpha', '0.2', 'LineWidth',1.5); % Plot the surface

xx=linspace(LED_2,0,2); zz=linspace(D,D-dw,2);
[x, z] = meshgrid(xx,zz); % Generate x and y data
y=(d-a*x-c*z)/b;
surf(z, x, y, 'EdgeColor', 'k', 'FaceColor', 'k', 'FaceAlpha', '0.4', 'LineWidth',1.5); % Plot the surface

xx=linspace(LED_2,0,2); zz=linspace(D/2+dw,D/2,2);
[x, z] = meshgrid(xx,zz); % Generate x and y data
y=(d-a*x-c*z)/b;
surf(z, x, y, 'EdgeColor', 'k', 'FaceColor', 'k', 'FaceAlpha', '0.4', 'LineWidth',1.5); % Plot the surface
...
%%------------------------------------------------------------------------------
sa=0.9*pi/2;
teflon_kaytarish=0.95;  %blue uchun
