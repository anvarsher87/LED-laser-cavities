...
yy=linspace(ly+L/2-dd/2,ly+L/2+dd/2,2); zz=linspace(dw,D/2-dw,2);
[y, z] = meshgrid(yy,zz); % Generate x and y data
x=(d-b*y-c*z)/a;
surf(z, x, y,  'EdgeColor', 'k', 'FaceColor', 'b', 'FaceAlpha', '0.2', 'LineWidth', 1.5); % Plot the surface


yy=linspace(ly+L/2-dd/2,ly+L/2+dd/2,2); zz=linspace(0,dw,2);
[y, z] = meshgrid(yy,zz); % Generate x and y data
x=(d-b*y-c*z)/a;
surf(z, x, y,  'EdgeColor', 'k', 'FaceColor', 'k', 'FaceAlpha', '0.4', 'LineWidth', 1.5); % Plot the surface


yy=linspace(ly+L/2-dd/2,ly+L/2+dd/2,2); zz=linspace(D/2-dw,D/2,2);
[y, z] = meshgrid(yy,zz); % Generate x and y data
x=(d-b*y-c*z)/a;
surf(z, x, y,  'EdgeColor', 'k', 'FaceColor', 'k', 'FaceAlpha', '0.4', 'LineWidth', 1.5); % Plot the surface
...
xx=linspace(LED_1,LED_1+l,2); zz=linspace(dw,D/2-dw,2);
[x, z] = meshgrid(xx,zz); 
y=(d-a*x-c*z)/b;
surf(z, x, y,  'EdgeColor', 'k', 'FaceColor', 'b', 'FaceAlpha', '0.2', 'LineWidth', 1.5); % Plot the surface

xx=linspace(LED_1,LED_1+l,2); zz=linspace(0,dw,2);
[x, z] = meshgrid(xx,zz); 
y=(d-a*x-c*z)/b;
surf(z, x, y,  'EdgeColor', 'k', 'FaceColor', 'k', 'FaceAlpha', '0.4', 'LineWidth', 1.5); % Plot the surface

xx=linspace(LED_1,LED_1+l,2); zz=linspace(D/2-dw,D/2,2);
[x, z] = meshgrid(xx,zz); 
y=(d-a*x-c*z)/b;
surf(z, x, y,  'EdgeColor', 'k', 'FaceColor', 'k', 'FaceAlpha', '0.4', 'LineWidth', 1.5); % Plot the surface
...
xx=linspace(LED_1+l,LED_1+H,2); zz=linspace(dw,D/2-dw,2);
[x, z] = meshgrid(xx,zz); 
y=(d-a*x-c*z)/b;
surf(z, x, y,  'EdgeColor', 'k', 'FaceColor', 'b', 'FaceAlpha', '0.2', 'LineWidth', 1.5); % Plot the surface

xx=linspace(LED_1+l,LED_1+H,2); zz=linspace(0,dw,2);
[x, z] = meshgrid(xx,zz); 
y=(d-a*x-c*z)/b;
surf(z, x, y,  'EdgeColor', 'k', 'FaceColor', 'k', 'FaceAlpha', '0.4', 'LineWidth', 1.5); % Plot the surface

xx=linspace(LED_1+l,LED_1+H,2); zz=linspace(D/2-dw,D/2,2);
[x, z] = meshgrid(xx,zz); 
y=(d-a*x-c*z)/b;
surf(z, x, y,  'EdgeColor', 'k', 'FaceColor', 'k', 'FaceAlpha', '0.4', 'LineWidth', 1.5); % Plot the surface
...
yy=linspace(ly+L/2-dd/2,ly+L/2+dd/2,2); zz=linspace(D/2+dw,D-dw,2);
[y, z] = meshgrid(yy,zz); % Generate x and y data
x=(d-b*y-c*z)/a;
surf( z, x, y, 'EdgeColor', 'k', 'FaceColor','b', 'FaceAlpha', '0.2', 'LineWidth', 1.5); % Plot the surface

yy=linspace(ly+L/2-dd/2,ly+L/2+dd/2,2); zz=linspace(D/2,D/2+dw,2);
[y, z] = meshgrid(yy,zz); % Generate x and y data
x=(d-b*y-c*z)/a;
surf( z, x, y, 'EdgeColor', 'k', 'FaceColor','k', 'FaceAlpha', '0.4', 'LineWidth', 1.5); % Plot the surface

yy=linspace(ly+L/2-dd/2,ly+L/2+dd/2,2); zz=linspace(D-dw,D,2);
[y, z] = meshgrid(yy,zz); % Generate x and y data
x=(d-b*y-c*z)/a;
surf( z, x, y, 'EdgeColor', 'k', 'FaceColor','k', 'FaceAlpha', '0.4', 'LineWidth', 1.5); % Plot the surface
...
xx=linspace(H-l,H,2); zz=linspace(D/2+dw,D-dw,2);
[x, z] = meshgrid(xx,zz); 
y=(d-a*x-c*z)/b;
surf(z, x, y,  'EdgeColor', 'k', 'FaceColor', 'b', 'FaceAlpha', '0.2', 'LineWidth', 1.5); % Plot the surface

xx=linspace(H-l,H,2); zz=linspace(D/2,D/2+dw,2);
[x, z] = meshgrid(xx,zz); 
y=(d-a*x-c*z)/b;
surf(z, x, y,  'EdgeColor', 'k', 'FaceColor', 'k', 'FaceAlpha', '0.4', 'LineWidth', 1.5); % Plot the surface

xx=linspace(H-l,H,2); zz=linspace(D-dw,D,2);
[x, z] = meshgrid(xx,zz); 
y=(d-a*x-c*z)/b;
surf(z, x, y,  'EdgeColor', 'k', 'FaceColor', 'k', 'FaceAlpha', '0.4', 'LineWidth', 1.5); % Plot the surface
...
xx=linspace(0,H-l,2); zz=linspace(D/2+dw,D-dw,2);
[x, z] = meshgrid(xx,zz); 
y=(d-a*x-c*z)/b;
surf(z, x, y,  'EdgeColor', 'k', 'FaceColor', 'b', 'FaceAlpha', '0.2', 'LineWidth', 1.5); % Plot the surface

xx=linspace(0,H-l,2); zz=linspace(D/2,D/2+dw,2);
[x, z] = meshgrid(xx,zz); 
y=(d-a*x-c*z)/b;
surf(z, x, y,  'EdgeColor', 'k', 'FaceColor', 'k', 'FaceAlpha', '0.4', 'LineWidth', 1.5); % Plot the surface

xx=linspace(0,H-l,2); zz=linspace(D-dw,D,2);
[x, z] = meshgrid(xx,zz); 
y=(d-a*x-c*z)/b;
surf(z, x, y,  'EdgeColor', 'k', 'FaceColor', 'k', 'FaceAlpha', '0.4', 'LineWidth', 1.5); % Plot the surface
%%------------------------ yon_chap_2b---------------------------------------
