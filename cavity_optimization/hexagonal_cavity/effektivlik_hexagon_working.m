function eff = effektivlik_hexagon_working(alfa, h)
% modif_hexagon_working dan olindi
...
% z_grid_number  = 499;       z_grid_size = DD/z_grid_number;
% 
...
for f=1:nuqta_fotonlar_soni_max
    ...
    %         yonalish=[cos(fi1) sin(fi1)*sin(psi1) sin(fi1)*cos(psi1)];
    %
    %     r_i=reshape(led_nuqta_kor(led_point, :),[1,3]);
