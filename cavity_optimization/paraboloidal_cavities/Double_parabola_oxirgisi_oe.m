...
% surf(zp,D*y,xp,'EdgeColor', 'None', 'FaceColor', 'k', 'FaceAlpha', '0.1')
surf(zp,(D-2)*y+1,xp,'EdgeColor', 'None', 'FaceColor', 'b', 'FaceAlpha', '0.2')
surf(zp+0.001,1*y,xp,'EdgeColor', 'None', 'FaceColor', 'k	', 'FaceAlpha', '0.4')
surf(zp+0.001,1*y+D-1,xp,'EdgeColor', 'None', 'FaceColor', 'k', 'FaceAlpha', '0.4')
...
patch(z, y3,  x,  's', 'FaceColor', 'k', 'FaceAlpha', '0.4','LineWidth',1.5);
...
surf(z+0.01, y, x,  'EdgeColor', 'None', 'FaceColor', 'b', 'FaceAlpha', '0.1') % Plot the surface
...
[y, x] = meshgrid(yy,xx); % Generate x and y data
z = zeros(size(x, 1)); % Generate z data
surf(z+LED_z-0.01, y, x,  'EdgeColor', 'None', 'FaceColor', 'b', 'FaceAlpha', '0.1') % Plot the surface
% surf(z+D/2-2,  y+h+LED_rod_masofa, x,'EdgeColor', 'None', 'FaceColor', 'w', 'FaceAlpha', '1') % Plot the surface
%------------------------------LED rasmi (orqa devor)----------------------
yy=linspace(D-2,L+2,2); xx=linspace(-12.5-2,12.5+2,2);
[y, x] = meshgrid(yy,xx); % Generate x and y data
z = zeros(size(x, 1)); % Generate z data
surf(z+LED_z+3, y, x,  'EdgeColor', 'None', 'FaceColor', 'c', 'FaceAlpha', '0.2') % Plot the surface
%------------------------------LED rasmi (yon devor)---------------------------------------------
r_k=20.5; theta=45; %for rotation plane
[xk, yk, zk]=cylinder(r_k, 4);
X2 = xk*cosd(theta) - yk*sind(theta);
...
surf(zp+0.01,(1)*y+2*D-1,xp,'EdgeColor', 'None', 'FaceColor', 'k', 'FaceAlpha', '0.4', 'LineWidth',1.5)
surf(zp+0.01,(1)*y+D,xp,'EdgeColor', 'None', 'FaceColor', 'k', 'FaceAlpha', '0.4', 'LineWidth',1.5)
%-------------------parabola_2---------------------------------------------
...
mm=2; n=19;
% y=(0:mm-1)'/(mm-1) * ones(1,n+1);
para_coefs_22=zeros(4,4); para_coefs_22(1,1)=-KK; para_coefs_22(1,4)=-KK*surish; para_coefs_22(4,1)=-KK*surish; para_coefs_22(4,4)=zc2-KK*surish^2; para_coefs_22(3,4)=1/2; para_coefs_22(4,3)=1/2; 
% surf(zp,D*y+D,xp,'EdgeColor', 'None', 'FaceColor', 'k', 'FaceAlpha', '0.1')
surf(zp,(D-2)*y+D+1,xp,'EdgeColor', 'None', 'FaceColor', 'b', 'FaceAlpha', '0.2', 'LineWidth',1.5)
surf(zp+0.01,(1)*y+2*D-1,xp,'EdgeColor', 'None', 'FaceColor', 'k', 'FaceAlpha', '0.4', 'LineWidth',1.5)
surf(zp+0.01,(1)*y+D,xp,'EdgeColor', 'None', 'FaceColor', 'k', 'FaceAlpha', '0.4', 'LineWidth',1.5)
